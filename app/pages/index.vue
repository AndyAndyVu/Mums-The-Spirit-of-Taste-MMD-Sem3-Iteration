...
></iframe> -->
    ...
    <section class="forsideIntro">
      ...
      <article class="forsideIntroText">
        ...
        <p>Velkommen til MUMS i Aalborg, et sted, hvor vi har æren af at præsentere takeaway i Aalborg med en unik
          smagsoplevelse og et glimt af gourmet mad i Aalborg.</p>
        <p>I to årtier har MUMS været et symbol på kvalitet, passion og respekt for smag. Vi sætter en ære i at bruge
          lokale råvarer, som vi omhyggeligt udvælger fra de bedste producenter i Nordjylland. Vi koger, sylter,
          braiserer og steger med kærlighed og giver vores retter et unikt MUMS-twist. Vi er stolte af at tilbyde mad ud
          af huset af høj kvalitet, hvor du kan opleve en fuldendt kombination af det visuelle, smagen og duften, der
          alle smelter sammen til "The spirit of taste."</p>
      </article>
    ...
    <section class="maanedensRetForside">
      ...
      <div class="maanedensRetText">
        ...
        <p><b>Vi tyvstarter allerede J-dag den 3. november med den store J-Burger-dag kl. 10:00 hos MUMS!</b></p>
        <p>Oplev vores jule Flæskestegsburger, lavet med saftig flæskesteg af dansk gris. I år har vi svøbt Julegrisen
          ind i tørsaltet bacon, fra Bødkeren i Nørresundby, toppet med flæskesvær fra Krastrupsøgaard.</p>
        <p>Med sprøde flæskesteg, hjemmelavet rødkål og agurkesalat – alt sammen pakket ind i en blød og luftig potato
          bun fra vores lokale bager her i Aalborg. En bolle smurt med vores hjemmelavet og cremet hvidløgs-mayo, og som
          prikken over i’et får du en spand legendarisk MUMS-sovs, til ære for julen, med oveni købet.</p>
        <p>Kan købes fra 3. november kl. 10:00 til 30. december kl. 18:00.</p>
    ...
    <section class="menuForside">
      <article class="menuForsideCard">
        ...
        <p>Vores nye menukort er skabt med respekt for den gastronomiske udvikling, som hele Take Away branchen
          gennemgår i disse år.</p>
        <p>Vi koger, sylter, braiserer og steger ud fra en regel om, at alt vi kan lave fra bunden det gør vi. Gerne med
          danske og lokale råvarer, som vi i tilberedningen giver vores helt eget lille twist, for at ramme den gode
          MUMS smag.</p>
      ...
      <article class="menuForsideCard">
        ...
        <h3>Catering Menu</h3>
        <p>Lad os tage os af madlavningen, mens du fokuserer på at have det sjovt og nyde tiden sammen med dine gæster!
        </p>
        <p>Vores fantastiske menuer er skræddersyet til enhver fest og garanterer at tilfredsstille enhver smag og
          appetit. Så hvorfor bruge tid på at bekymre dig om maden, når du kan stole på os til at levere en mindeværdig
          madoplevelse, som vil imponere alle dine gæster.</p>
    ...
    <section>
      <article class="delikatesseForside">
        ...
        <div class="forsideText">
          <h3>Deliktatesse</h3>
          <p>Glæd din familie, venner, medarbejdere og forretningsforbindelser med engave der ”smager” af MUMS. Vi har
            samlet de bedste danske og udenlandske producenter og er glade for også at kunne præsentere egne
            hjemmelavede produkter.</p>
          <p>Vi sælger et bredt udvalg af premium fødevarer, herunder vin, øl, te, kaffe, chokolade, slik, spiritus,
            olie og eddike fra Oil & Vinegar, pesto, tapenader, pasta, oliven, brødsnacks, tapas rette, samt et bredt
            udvalg fra de bedste danske og udenlandske specialvarer producenter.</p>
      ...
      <article class="omOsForside">
        <div class="forsideText">
          <h3>Om os</h3>
          <p>I hjertet af Aalborg finder du MUMS, hvor takeaway er hævet til et nyt niveau. Vi har sammensmeltet det
            bedste fra gourmet mad i Aalborg med behageligheden af mad ud af huset, hvilket resulterer i en unik
            smagsoplevelse. Uanset om du vælger vores tapas retter, lun leverpostej, eller en af de mange internationale
            smagsoplevelser, leverer MUMS hver gang.</p>
